...
public sealed class DeepSeekChatProvider : IAiChatProvider
{
        ...
        Guid? correlationId = null)
    {
        ...
        {
            sw.Stop();
            _ = _apiUsage.LogAsync("deepseek", "ExpertChat", null, (int)sw.ElapsedMilliseconds, ct,
                requestBody: userContent, correlationId: correlationId, usedModel: "DS");
            ...
            or HttpStatusCode.BadGateway)
        {
            ...
            _ = _apiUsage.LogAsync("deepseek", "ExpertChat", (int)response.StatusCode, (int)sw.ElapsedMilliseconds, ct,
                requestBody: userContent, responseBody: body, correlationId: correlationId, usedModel: "DS");
            return new AiChatResult(null, Name, false) { IsTransient = true, UsedModel = "DS" };
        }
    ...
    private record DeepSeekUsage([property: JsonPropertyName("total_tokens")] int? TotalTokens);
}
